	...
	if ( $archive_title || $archive_subtitle ) {
		...
		foreach ($result as $post) {
			...
			echo "<div class='card' style=' display: inline-block; float:right; width: 70%; height:100%;'>";
				...
				echo '<span class="date-update" style="display: inline-block; float:right; font-size:10px; color: #525252; margin-right: 50px; margin-top:5px;">Actualizado: '.$date_updated.'</span>';
				echo '</p>';
